...
export const PROJECTS = [
  ...
  {
    id: 5,
    title: "R6 Operator Guesser",
    subtitle: "Rainbow Six Siege Operator Guesser",
    description: "A fun web app where you guess Rainbow Six Siege operators from their silhouette and sound clues.",
    tags: ["React", "CSS"],
    category: "App",
    color: "#57b8ff",
    emoji: "🎮",
    github: "https://github.com/xxVertex/r6-operator-guesser",
    liveUrl: "https://xxvertex.github.io/R6-Operator-Guesser/",
    featured: true,
  },
];
