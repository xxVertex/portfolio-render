...
export const PROJECTS = [
  ...
  {
    id: 6,
    title: "A320 Startup Simulator",
    subtitle: "Airbus A320 Startup Simulation",
    description: "A simulation of the startup process for an Airbus A320 aircraft, including the pre-start checklist, engine start, and taxi procedures.",
    tags: ["React", "CSS"],
    category: "Simulation",
    color: "#e94560",
    emoji: "✈️",
    github: "https://github.com/xxVertex/a320-startup-simulator",
